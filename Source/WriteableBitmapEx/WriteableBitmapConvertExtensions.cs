 ...
 static partial class WriteableBitmapExtensions
    {
        ...
        public static byte[] ToByteArray(this WriteableBitmap bmp, int offset, int count)
        {
            ...
            {
                return context.ToByteArray(offset, count);
            }
        }

        /// <summary>
        /// Copies the Pixels from the BitmapContext into a ARGB byte array starting at a specific Pixels index.
        /// </summary>
        ...
        /// <summary>
        /// Copies color information from an ARGB byte array into this BitmapContext starting at a specific buffer index.
        /// </summary>
        /// <param name="context">The BitmapContext.</param>
        /// <param name="offset">The starting index in the buffer.</param>
        /// <param name="count">The number of bytes to copy from the buffer.</param>
        /// <param name="buffer">The color buffer as byte ARGB values.</param>
        /// <returns>The BitmapContext that was passed as parameter.</returns>
        ...
        /// <summary>
        /// Copies color information from an ARGB byte array into this BitmapContext.
        /// </summary>
        /// <param name="context">The BitmapContext.</param>
        /// <param name="count">The number of bytes to copy from the buffer.</param>
        /// <param name="buffer">The color buffer as byte ARGB values.</param>
        ...
        /// <summary>
        /// Copies all the color information from an ARGB byte array into this BitmapContext.
        /// </summary>
        /// <param name="context">The BitmapContext.</param>
        /// <param name="buffer">The color buffer as byte ARGB values.</param>
        /// <returns>The BitmapContext that was passed as parameter.</returns>
