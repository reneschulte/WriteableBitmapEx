 ...
 static partial class WriteableBitmapExtensions
    {
        ...
        /// <summary>
        /// Copies (blits) the pixels from the BitmapContext source to the destination BitmapContext (this).
        /// </summary>
        /// <param name="context">The destination BitmapContext.</param>
        /// <param name="destRect">The rectangle that defines the destination region.</param>
        /// <param name="sourceContext">The source BitmapContext.</param>
        /// <param name="sourceRect">The rectangle that will be copied from the source to the destination.</param>
        /// <param name="blendMode">The blending mode <see cref="BlendMode"/>.</param>
        public static void Blit(this BitmapContext context, Rect destRect, BitmapContext sourceContext, Rect sourceRect, BlendMode blendMode)
        {
            Blit(context, destRect, sourceContext, sourceRect, Colors.White, blendMode);
        }
        ...
        /// <param name="sourceContext">The source BitmapContext.</param>
        /// <param name="sourceRect">The rectangle that will be copied from the source to the destination.</param>
        public static void Blit(this BitmapContext context, Rect destRect, BitmapContext sourceContext, Rect sourceRect)
        {
            Blit(context, destRect, sourceContext, sourceRect, Colors.White, BlendMode.Alpha);
        }
        ...
        /// <param name="color">If not Colors.White, will tint the source image. A partially transparent color and the image will be drawn partially transparent.</param>
        /// <param name="blendMode">The blending mode <see cref="BlendMode"/>.</param>
        public static void Blit(this BitmapContext context, Point destPosition, BitmapContext sourceContext, Rect sourceRect, Color color, BlendMode blendMode)
        {
            var destRect = new Rect(destPosition, new Size(sourceRect.Width, sourceRect.Height));
            Blit(context, destRect, sourceContext, sourceRect, color, blendMode);
        }
        ...
        internal static void Blit(this WriteableBitmap bmp, Rect destRect, WriteableBitmap source, Rect sourceRect, Color color, BlendMode blendMode)
        {
            ...
            {
                destContext.Blit(destRect, srcContext, sourceRect, color, blendMode);
            }
        }
        ...
        /// <param name="context">The destination BitmapContext.</param>
        /// <param name="destRect">The rectangle that defines the destination region.</param>
        /// <param name="srcContext">The source BitmapContext.</param>
        /// <param name="sourceRect">The rectangle that will be copied from the source to the destination.</param>
        /// <param name="color">If not Colors.White, will tint the source image. A partially transparent color and the image will be drawn partially transparent. If the BlendMode is ColorKeying, this color will be used as color key to mask all pixels with this value out.</param>
        /// <param name="blendMode">The blending mode <see cref="BlendMode"/>.</param>
        internal static void Blit(this BitmapContext context, Rect destRect, BitmapContext srcContext, Rect sourceRect, Color color, BlendMode blendMode)
        {
            if (color.A == 0)
            {
                return;
            ...
            var dpw = context.Width;
            var dph = context.Height;
            ...
            for (int j = 0; j < dh; j++)
            {
                if (y >= 0 && y < dph)
                {
                    ...
                    if (blendMode == BlendMode.None && !tinted)
                    {
                        ...
                        if (len > sw) len = sw;
                        if (len > dw) len = dw;
                        BitmapContext.BlockCopy(srcContext, (sourceIdx + offset) * 4, context, (idx + offset) * 4, len * 4);
                    }
        ...
        public static void BlitRender(this WriteableBitmap bmp, WriteableBitmap source, bool shouldClear = true, float opacity = 1f, GeneralTransform transform = null)
        {
            ...
            {
                destContext.BlitRender(sourceContext, shouldClear, opacity, transform);
            }
        }
        ...
        /// It's used in Fantasia Painter for drawing stickers and 3D objects on screen
        /// </summary>
        /// <param name="context">Destination bitmap.</param>
        /// <param name="sourceContext">The source BitmapContext.</param>
        /// <param name="shouldClear">If true, the the destination bitmap will be set to all clear (0) before rendering.</param>
        /// <param name="opacity">opacity of the source bitmap to render, between 0 and 1 inclusive</param>
        /// <param name="transform">Transformation to apply</param>
        public static void BlitRender(this BitmapContext context, BitmapContext sourceContext, bool shouldClear = true, float opacity = 1f, GeneralTransform transform = null)
        {
            ...
            var destPixels = context.Pixels;
            int destWidth = context.Width;
            int destHeight = context.Height;
            var inverse = transform.Inverse;
            if(shouldClear) context.Clear();
