 ...
 static partial class WriteableBitmapExtensions
    {
      ...
      public static int[] Resize(int[] pixels, int widthSource, int heightSource, int width, int height, Interpolation interpolation)
        ...
        /// <param name="destPixels">Pixels for destination bitmap</param>
        /// <param name="destWidth">Width of destination bitmap</param>
        /// <param name="destHeight">Height of destination bitmap</param>
        ...
        public static void Render(this WriteableBitmap bmp, int[] destPixels, int destWidth, int destHeight, float opacityF, GeneralTransform forward, GeneralTransform inverse)
        {
            ...
            using (BitmapContext sourceContext = bmp.GetBitmapContext())
            {
                ...
                Array.Clear(destPixels, 0, destPixels.Length);
                int index = 0;
